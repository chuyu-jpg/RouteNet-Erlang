...
min_scale = 1
max_scale = 20
ds_train = input_fn('/kaggle/working/scalability/train/', min_scale=min_scale, max_scale=max_scale, samples_per_sample=1,
                    shuffle=True)
...
ds_test = input_fn('/kaggle/working/scalability/test/', min_scale=10, max_scale=11, shuffle=False)
